...
def getData(var):
    ...
    with open(f"{director}\\Camera_de_Comert_si_Industrie_Iasi.txt", "w", encoding="utf-8") as file:
        file.write(cci_text)

    #writing content to .html file in HTMLFiles
    with open(f"{HTMLFiles}\\Camera_de_Comert_si_Industrie_Iasi.html", "w", encoding="utf-8") as file:
